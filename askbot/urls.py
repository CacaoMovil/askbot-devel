...
MAIN_PAGE_BASE_URL = getattr(settings, 'ASKBOT_MAIN_PAGE_BASE_URL',
                             pgettext('urls', 'questions')).strip('/') + '/'
QUESTION_PAGE_BASE_URL = getattr(settings, 'ASKBOT_QUESTION_PAGE_BASE_URL',
                                 pgettext('urls', 'question')).strip('/') + '/'
